...
public class main {
    ...
    public static void main(String[] args) {
        ...
        Set<String> collector = Permute.permuteAndStore(TEXT);
        ...
        Stream<String> result = Permute.permuteAndReturnStream(TEXT);
        ...
        Permute.permuteAndPrintStream(TEXT);
